...
output_channel_figure_file    = paste(pathtofigurefile, "channel_figure_eeglab_mgcca", sep = "")
output_time_figure_file       = paste(pathtofigurefile, "time_figure_ggplot_mgcca", sep = "")
channel_figure_parameter_file = paste(pathtofigurefile, "channel_figure_parameter_file_mgcca", sep = "")
